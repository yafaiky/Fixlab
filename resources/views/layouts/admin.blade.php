...
<body class="bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
    ...
    flex flex-col"
            ...
            <nav class="flex-1 p-4 space-y-2">
               ...
               {{ request()->routeIs('admin.dashboard') ? 'bg-blue-600 shadow-lg transform scale-105' : 'hover:bg-gray-700' }}">
                ...
                <a href="{{ route('admin.service') }}" @click="sidebarOpen = false"
                    class="flex items-center gap-3 rounded-lg px-4 py-3 transition-all duration-200
               {{ request()->routeIs('admin.service') ? 'bg-blue-600 shadow-lg transform scale-105' : 'hover:bg-gray-700' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M12 6v6m0 0v6m0-6h6m0 0h6M6 12a6 6 0 1112 0 6 6 0 01-12 0z"></path>
                    </svg>
                    <span class="font-medium">Service Baru</span>
                </a>
            </nav>
