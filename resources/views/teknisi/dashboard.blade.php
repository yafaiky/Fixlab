        ...
        <div class="space-y-4">
            ...
            <form id="searchForm" method="GET" action="{{ route('teknisi.dashboard') }}" class="flex items-center gap-2">
                ...
                <div class="relative w-full max-w-md">
                    ...
                    <input type="text" id="searchInput" name="search" value="{{ $search }}" autocomplete="off"
                ...
                <button type="submit"
                    class="p-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 shadow-sm transition-all active:scale-95">
        ...
        <div class="mt-5">
                        ...
                        <div
                            ...
                            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 px-4 py-3 border-b border-gray-200">
                                <div class="flex justify-between items-start">
                                    <div>
                                        <h3 class="text-sm font-semibold text-gray-900">{{ $service->customer->name }}
                                        </h3>
                            ...
                            <div class="px-4 py-3">
                                <div class="space-y-2 text-xs">
                                    ...
                                    <div class="flex items-center pt-1">
                                        <svg class="w-3.5 h-3.5 text-gray-400 mr-1.5" fill="none"
            ...
            @else
                <div class="text-center py-10 text-sm text-gray-500">
                    <img src="{{ asset('images/logo-fixlab.png') }}" alt="No Data"
                        class="mx-auto h-10 grayscale opacity-60">
