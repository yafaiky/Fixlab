...
<head>
    <meta charset="utf-8" />
    <title>Tanda Terima Service - {{ $service->id }}</title>
    <style>
        :root {
            --primary: #0f62fe;
...
<body>
    ...
    <div class="container">
        ...
        <div class="body">
                ...
                <div class="card">
                    ...
                    <table class="info-table">
                        ...
                        <tr>
                            ...
                            <td class="value">{{ $service->created_at->format('d F Y') }}</td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="card">
                    ...
                    <table class="info-table">
                        ...
                        <tr>
                            ...
                            <td class="value">{{ $service->Kondisi ?? '-' }}</td>
                        </tr>
                    </table>
                </div>
            </div>
            ...
            <!-- Photo Section -->
            @if ($service->media && $service->media->first()?->dokumentasi)
                <div class="foto-section">
                    <div class="card-title">Foto Kondisi Awal</div>
                    <div class="foto-grid">
                        @forelse($service->media->first()->dokumentasi as $foto)
                            @php
                ...
                <div class="sig-box">
                    ...
                    <div class="sig-frame">
                        @php
                            ...
                            $hasSignature = $media && $media->signature;
                        @endphp
                        @if ($hasSignature)
                            @php
                                $sigPath = storage_path('app/public') . '/' . $media->signature;
                            @endphp
                    ...
                    <div class="sig-name">{{ $service->created_at->format('d F Y') }}</div>
                </div>
            </div>
        </div>
