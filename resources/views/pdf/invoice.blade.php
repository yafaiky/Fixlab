...
<head>
    <meta charset="utf-8" />
    <title>Invoice Update Service - {{ $service->id }}</title>
    <style>
        :root {
            --primary: #0f62fe;
        ...
        <div class="body">
            ...
            <div class="card">
                ...
                <table class="info-table">
                    <tr>
                        ...
                        <td class="value">{{ $service->created_at->format('d F Y H:i') }}</td>
                    </tr>
                    <tr>
            ...
            <div class="summary">
                ...
                <div class="warranty">
                    ...
                    <span>{{ $service->garansi ? \Carbon\Carbon::parse($service->garansi)->format('d F Y') : '-' }}</span>
                </div>
        </div>
